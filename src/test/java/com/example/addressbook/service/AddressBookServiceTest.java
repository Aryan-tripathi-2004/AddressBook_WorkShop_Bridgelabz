...
class AddressBookServiceTest {
    ...
    void setUp() {
        ...
        addressBook.setFirstName("Aryan");
        addressBook.setLastName("Tripathi");
        addressBook.setEmail("aryantripathi1606@gmail.com");
    ...
    void testGetAddressBookData() {
        ...
        assertEquals("Aryan", result.get(0).getFirstName());
        assertEquals("Tripathi", result.get(0).getLastName());
        assertEquals("aryantripathi1606@gmail.com", result.get(0).getEmail());
    }
    ...
    void testGetAddressBookDataById() {
        ...
        assertNotNull(result);
        assertEquals("Aryan", result.getFirstName());
        assertEquals("Tripathi", result.getLastName());
        assertEquals("aryantripathi1606@gmail.com", result.getEmail());
    }
